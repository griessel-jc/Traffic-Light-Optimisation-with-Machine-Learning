                ...
                <div className="main-wrapper">
                    ...
                    <div className="download-wrapper">
                        ...
                        <div className="download-link-wrapper col-12">
                            <a href="../images/Aegis_logo.png" download="Window_build"><div className="download-link">Windows</div></a>
                            <a href="../images/Aegis_logo.png" download="Mac_build"><div className="download-link">Mac</div></a>
                            <a href="../images/Aegis_logo.png" download="Linux_build"><div className="download-link">Linux</div></a>
                        </div>
